            ...
            <form action="" className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
                <div>
                    ...
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                        ...
                        <input type="text" placeholder='Enter Your Name' className='w-full p-3 test-sm outline-none' />
                    </div>
                </div>
                <div>
                ...
                <div className='sm:col-span-2'>
                    ...
                    <textarea name="" rows={8} placeholder='Enter your message' className='w-full p-3 tesx-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' />
                </div>
