...
function Footer({theme}) {
    return (
        <div className="bg-slate-200 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40">
            ...
            <div className="pb-6 text-sm text-gray-50 flex justify-center sm:justify-between gap-4 flex-wrap">
                <p className="text-primary dark:text-white">Copyright 2025 &copy; SafaeiTech - All Right Reserved.</p>
