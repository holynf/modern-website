    ...
    return (
        ...
        >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5xl">
                ...
                <span className="bg-gradiant-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent">
                    digital
                </span>
                impact.
            </h1>
            ...
            <div className="relative">
                ...
                <img src={assets.bgImage1} alt="hero image" className="absolute w-full h-full -top-40! -right-40! sm:-top-100 sm:-right-70 -z-1 dark:hidden" />
            </div>
        </div>
    );
}
